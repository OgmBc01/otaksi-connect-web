...
export default function frauddetectionsecurebankPage() {
  ...
  useEffect(() => {
    ...
    // TODO: Implement unique animation for FinTech case study
    let time = 0
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-6">
                SecureBank, a leading FinTech organization in the UAE, faced significant 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                We developed a comprehensive FinTech solution that transformed their operations:
              </p>
              <div className="space-y-4">
      ...
      <section className="relative py-16 bg-midnight border-t border-white/5 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
                          <span className='px-4 py-2 glass-card rounded-full text-sm text-gray-300 border border-white/10'>Python</span>
              <span className='px-4 py-2 glass-card rounded-full text-sm text-gray-300 border border-white/10'>TensorFlow</span>
              <span className='px-4 py-2 glass-card rounded-full text-sm text-gray-300 border border-white/10'>Apache Kafka</span>
      ...
      <section className="relative py-16 bg-midnight border-t border-white/5 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-2xl font-bold gradient-text mb-2">99.9% accuracy</div>
              <div className="text-sm text-gray-500">Improvement</div>
            </div>
            <div className="glass-card p-6 text-center">
              <div className="text-2xl font-bold gradient-text mb-2">Real-time detection</div>
              <div className="text-sm text-gray-500">Improvement</div>
            </div>
            <div className="glass-card p-6 text-center">
              <div className="text-2xl font-bold gradient-text mb-2">50% false positive reduction</div>
              <div className="text-sm text-gray-500">Improvement</div>
            </div>
            <div className="glass-card p-6 text-center">
              <div className="text-2xl font-bold gradient-text mb-2">2M+ transactions/day</div>
              <div className="text-sm text-gray-500">Improvement</div>
            </div>
          </div>
          <div className="mt-12 text-center">
            <div className="inline-block glass-card px-8 py-4 rounded-full">
              <p className="text-xl font-bold gradient-text">Saved AED 50M+ in potential fraud losses</p>
            </div>
          </div>
        </div>
      </section>
