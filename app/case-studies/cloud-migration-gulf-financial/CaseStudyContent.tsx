...
export default function cloudmigrationgulffinancialPage() {
  ...
  useEffect(() => {
    ...
    // TODO: Implement unique animation for Financial Services case study
    let time = 0
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-6">
                Gulf Financial, a leading Financial Services organization in the UAE, faced significant 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                We developed a comprehensive Financial Services solution that transformed their operations:
              </p>
              <div className="space-y-4">
      ...
      <section className="relative py-16 bg-midnight border-t border-white/5 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-2xl font-bold gradient-text mb-2">50+ apps migrated</div>
            ...
            <div className="glass-card p-6 text-center">
              <div className="text-2xl font-bold gradient-text mb-2">40% cost reduction</div>
              <div className="text-sm text-gray-500">Improvement</div>
            </div>
            <div className="glass-card p-6 text-center">
              <div className="text-2xl font-bold gradient-text mb-2">99.99% uptime</div>
              <div className="text-sm text-gray-500">Improvement</div>
            </div>
          </div>
          <div className="mt-12 text-center">
            <div className="inline-block glass-card px-8 py-4 rounded-full">
              <p className="text-xl font-bold gradient-text">Cloud-native transformation complete in 6 months</p>
            </div>
          </div>
        </div>
      </section>
