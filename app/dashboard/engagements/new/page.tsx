...
export default function NewEngagementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Insert tasks
    if (tasks.length > 0 && tasks[0].task_name) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateTask(index, 'hourly_rate', parseFloat(e.target.value))}
                      className="admin-input"
                      placeholder="0.00"
                      step="0.01"
                    />
                    ...
                    <input
                      type="number"
                      value={task.hourly_rate}
                      onChange={(e) => updateTask(index, 'hourly_rate', e.target.value === '' ? 0 : parseFloat(e.target.value))}
                      className="admin-input"
                      placeholder="0.00"
                      step="0.01"
                    />
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={task.estimated_hours}
                      onChange={(e) => updateTask(index, 'estimated_hours', e.target.value === '' ? 0 : parseFloat(e.target.value))}
                      className="admin-input"
                      placeholder="0"
                      step="0.5"
                    />
                  ...
                  <div>
                    ...
                    <div className="admin-input bg-gray-50">
                      AED {(task.estimated_hours * task.hourly_rate).toFixed(2)}
                    </div>
                  </div>
                </div>
              </div>
