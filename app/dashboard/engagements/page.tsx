                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg border border-red-400 bg-white text-red-600 hover:bg-red-50 transition-colors opacity-0 group-hover:opacity-100 ml-1"
