      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-900 font-semibold">View and manage all payment receipts</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="admin-card">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-900 font-semibold">Total Receipts Issued</p>
          ...
          <div className="admin-card">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-900 font-semibold">Total Amount Receipted</p>
                ...
                <div className="relative admin-card p-6">
                  ...
                  <div className="flex gap-2 justify-end pt-4 border-t border-gray-200">
                    <button
                      ...
                      className="text-xs px-3 py-1 rounded-lg bg-[#5B6CFF] text-white hover:bg-[#4B5CFF] transition-colors flex items-center gap-1"
                    >
                      <span>📄</span>
                      PDF
                    </button>
