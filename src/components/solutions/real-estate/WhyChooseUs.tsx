...
const reasons = [
  {
    ...
    description: 'Deep understanding of Dubai\'s property market, regulations, and industry practices.',
    icon: '🏗️',
    image: '/images/solutions/real-estate/why-expertise.jpg',
    gradient: 'linear-gradient(135deg, #FF2E9F 0%, #5B6CFF 100%)',
    stats: '20+ years experience'
  },
  {
    title: 'Ejari Integration Specialists',
    description: 'Certified experts in integrating with Dubai\'s Ejari system for tenancy contract management.',
    icon: '📝',
    image: '/images/solutions/real-estate/why-ejari.jpg',
    gradient: 'linear-gradient(135deg, #5B6CFF 0%, #FF2E9F 100%)',
    stats: '50K+ contracts processed'
  },
  {
    title: 'IoT & Smart Building Experts',
    description: 'Specialists in IoT-enabled building management and smart building solutions.',
    icon: '🏙️',
    image: '/images/solutions/real-estate/why-iot.jpg',
    gradient: 'linear-gradient(135deg, #FF2E9F 0%, #5B6CFF 100%)',
    stats: '100+ smart buildings'
  },
  {
    title: 'Scalable Platforms',
    description: 'Solutions designed to grow from single properties to enterprise portfolios.',
    icon: '📈',
    image: '/images/solutions/real-estate/why-scalable.jpg',
    gradient: 'linear-gradient(135deg, #5B6CFF 0%, #FF2E9F 100%)',
    stats: '50K+ units managed'
  },
  {
    title: 'RERA Compliance',
    description: 'Solutions compliant with Dubai Real Estate Regulatory Agency requirements.',
    icon: '✓',
    image: '/images/solutions/real-estate/why-rera.jpg',
    gradient: 'linear-gradient(135deg, #FF2E9F 0%, #5B6CFF 100%)',
    stats: '100% compliant'
  },
  {
    title: 'Proven Track Record',
    description: 'Successful implementations for leading developers and property managers in UAE.',
    icon: '🏆',
    image: '/images/solutions/real-estate/why-proven.jpg',
    gradient: 'linear-gradient(135deg, #5B6CFF 0%, #FF2E9F 100%)',
    stats: '50+ real estate clients'
  }
]
...
export default function WhyChooseUs() {
  ...
  // Unique animated background for Why Choose Us section (property badges)
  useEffect(() => {
    ...
    // Create floating property badges
    const badges = ['RERA', 'Ejari', 'DEWA', 'DLD', 'DTCM', 'Trakheesi']
    ...
    const animate = () => {
      ...
      buildings.forEach((building) => {
        ...
        for (let w = 0; w < 5; w++) {
          if (building.height > w * 30) {
            ctx.fillRect(building.x + 10, building.y - building.height + w * 30 + 10, 10, 15)
            ctx.fillRect(building.x + 35, building.y - building.height + w * 30 + 10, 10, 15)
          }
        }
      })
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            ...
            solutions that transform property management and operations.
          </p>
        </motion.div>
        ...
        >
          <p className="text-sm text-gray-500 mb-6">Trusted by leading real estate companies</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50">
            {['Emaar', 'Nakheel', 'Dubai Properties', 'Wasl', 'Meraas', 'DAMAC'].map((company, index) => (
