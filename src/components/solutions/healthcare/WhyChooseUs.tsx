...
const reasons = [
  {
    ...
    description: 'Deep understanding of clinical workflows, patient care, and healthcare regulations in UAE.',
    icon: '⚕️',
    image: '/images/solutions/healthcare/why-expertise.jpg',
    gradient: 'linear-gradient(135deg, #FF2E9F 0%, #5B6CFF 100%)',
    stats: '20+ years healthcare IT'
  },
  {
    title: 'DHA Compliance',
    description: 'Solutions built to meet Dubai Health Authority regulations and standards.',
    icon: '✓',
    image: '/images/solutions/healthcare/why-dha.jpg',
  ...
  },
  {
    ...
    icon: '🔒',
    image: '/images/solutions/healthcare/why-security.jpg',
    gradient: 'linear-gradient(135deg, #FF2E9F 0%, #5B6CFF 100%)',
    stats: 'ISO 27001 certified'
  },
  {
    title: 'Interoperability Experts',
    description: 'Seamless integration using HL7, FHIR, and other healthcare standards.',
    icon: '🔄',
    image: '/images/solutions/healthcare/why-interop.jpg',
    gradient: 'linear-gradient(135deg, #5B6CFF 0%, #FF2E9F 100%)',
    stats: 'HL7/FHIR certified'
  },
  {
    title: 'Clinical Workflow Optimization',
    description: 'Solutions designed to enhance clinical workflows and reduce administrative burden.',
    icon: '⚙️',
    image: '/images/solutions/healthcare/why-workflow.jpg',
    gradient: 'linear-gradient(135deg, #FF2E9F 0%, #5B6CFF 100%)',
    stats: '40% efficiency gain'
  },
  {
    title: 'Proven Track Record',
    description: 'Successful implementations for leading healthcare providers across UAE.',
    icon: '🏆',
    image: '/images/solutions/healthcare/why-proven.jpg',
    gradient: 'linear-gradient(135deg, #5B6CFF 0%, #FF2E9F 100%)',
...
export default function WhyChooseUs() {
  ...
  // Unique animated background for Why Choose Us section (medical badges)
  useEffect(() => {
    ...
    // Create floating medical badges
    const badges = ['DHA', 'HIPAA', 'JCI', 'ISO', 'HL7', 'FHIR', 'MOHAP', 'DHCC']
    ...
    // Create medical cross outlines
    const crosses: { x: number; y: number; size: number; pulse: number }[] = []
    ...
    const animate = () => {
      ...
      crosses.forEach((cross) => {
        cross.pulse += 0.02
        const pulseSize = cross.size + Math.sin(cross.pulse) * 5

        // Draw plus sign
        ctx.strokeStyle = 'rgba(255, 46, 159, 0.1)'
        ctx.lineWidth = 1
        ctx.strokeRect(cross.x - pulseSize/2, cross.y - pulseSize/6, pulseSize, pulseSize/3)
        ctx.strokeRect(cross.x - pulseSize/6, cross.y - pulseSize/2, pulseSize/3, pulseSize)
      })
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            We combine clinical expertise with innovative technology to deliver 
        ...
        >
          <p className="text-sm text-gray-500 mb-6">Trusted by leading healthcare providers</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50">
            {['DHA', 'Mediclinic', 'NMC', 'Aster', 'Cleveland Clinic', 'Johns Hopkins'].map((company, index) => (
