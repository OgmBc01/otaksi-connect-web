...
export default function CTASection() {
  ...
  // Unique animated background for CTA section (rising citizen satisfaction)
  useEffect(() => {
    ...
    // Create rising satisfaction graph
    const satisfactionData: number[] = []
    for (let i = 0; i < 50; i++) {
      satisfactionData.push(50 + Math.random() * 50)
    }
    ...
    // Create government building icons
    const buildings: { x: number; y: number; type: string; size: number; speedY: number; opacity: number }[] = []
    ...
    const animate = () => {
      ...
      // Update and draw satisfaction graph
      satisfactionData.shift()
      satisfactionData.push(50 + Math.random() * 50 + Math.sin(time) * 20)

      ctx.beginPath()
      ctx.moveTo(0, 400 - satisfactionData[0])

      for (let i = 1; i < satisfactionData.length; i++) {
        ctx.lineTo(i * 20, 400 - satisfactionData[i])
      }
      ...
      ctx.lineTo(satisfactionData.length * 20, 400)
      ctx.lineTo(0, 400)
      ...
      // Draw floating government buildings
      buildings.forEach((building) => {
        building.y -= building.speedY
        ...
        ctx.fillStyle = `rgba(91, 108, 255, ${building.opacity})`
  ...
  return (
    <section className="relative py-24 bg-midnight overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          src="/images/solutions/government/cta-bg.jpg"
          alt="Government CTA"
          fill
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            Let's discuss how our government solutions can help you deliver better
            citizen services, improve efficiency, and achieve digital transformation goals.
          </motion.p>
          ...
          >
            ...
            <Button variant="secondary" size="large">
              Download Government Solutions Guide
            </Button>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
              <Link href="mailto:government@otaksi.ae" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors group">
                ...
                <span>government@otaksi.ae</span>
              </Link>
          ...
          >
            <p className="text-xs text-gray-600">
              ⚡ Free consultation | Security compliant | Citizen-centric design | 24/7 support
            </p>
          </motion.div>
        </motion.div>
      </div>
