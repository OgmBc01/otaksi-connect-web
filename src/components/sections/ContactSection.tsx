...
const contactInfo = [
  {
    icon: '📍',
    title: 'UAE Office',
    details: ['Compass Building, Al Shohada Road, Al Hamra Industrial Zone-FZ, Ras Al Khaimah, United Arab Emirates.'],
    gradient: 'from-[#FF2E9F] to-[#5B6CFF]'
  },
  {
    icon: '📞',
    title: 'Contact',
    details: ['+971 58 255 1785', 'info@otaksiconnect.com', 'admin@otaksiconnect.com'],
...
const socialLinks = [
  {
    ...
    href: 'https://www.linkedin.com/company/otaksiconnect/',
  },
  {
    name: 'Facebook',
    icon: (
    ...
    href: 'https://www.facebook.com/share/1B1iDS6adq/?mibextid=wwXIfr',
  },
  {
    name: 'Instagram',
    icon: (
    ...
    href: 'https://www.instagram.com/otaksi_connect?igsh=MTh1Ymo1N3U2dTU3MA%3D%3D&utm_source=qr',
  },
  {
    name: 'GitHub',
    icon: (
  ...
  },
  {
    ...
    href: 'https://x.com/otaksiconnect?s=21&t=ibFSOu827HL8-PFr_30XMg',
  },
]
