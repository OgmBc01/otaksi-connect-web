          ...
          {industries.map((industry, index) => (
            ...
            >
              <div className="relative h-full glass-card p-6 hover:scale-[1.02] transition-all duration-300 overflow-hidden">
                ...
                <div 
                  className={`absolute -inset-1 bg-linear-to-r ${industry.gradient} rounded-3xl opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-500`}
                />
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-linear-to-r from-[#FF2E9F]/10 to-[#5B6CFF]/10 flex items-center justify-center">
