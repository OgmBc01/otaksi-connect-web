  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-midnight pt-24">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          src="/images/ai-automation/hero-ai.jpg"
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Transform your business with intelligent automation solutions powered by 
              machine learning, computer vision, and NLP. From predictive analytics to 
              robotic process automation, we help UAE enterprises leverage AI for 
