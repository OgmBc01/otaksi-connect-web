  ...
  return (
    <section className="relative py-24 bg-midnight overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          src="/images/cloud-platforms/cta-bg.jpg"
          alt="Cloud Platforms CTA"
          fill
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2E9F] to-[#5B6CFF]">Infrastructure?</span>
          </motion.h2>
          ...
          >
            Let's discuss how cloud platforms can drive scalability, reduce costs, 
            and accelerate innovation for your organization.
          </motion.p>
          ...
          >
            ...
            <Button variant="secondary" size="large">
              Download Cloud Capabilities Deck
            </Button>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
              <Link href="mailto:cloud@otaksi.ae" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors group">
          ...
          >
            <p className="text-xs text-gray-600">
              ⚡ Free initial cloud assessment | 24/7 support included | Certified AWS/Azure/GCP partners
            </p>
          </motion.div>
        </motion.div>
      </div>
