  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-midnight pt-24">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          src="/images/cloud-platforms/hero-cloud.jpg"
          alt="Cloud Platforms Background"
          fill
          ...
          <div>
            ...
            >
              <nav className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <span>•</span>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2E9F] to-[#5B6CFF]">Cloud Platforms</span>
              </nav>
            </motion.div>
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2E9F] to-[#5B6CFF]">Platforms</span>
              <br />
              <span className="text-3xl md:text-4xl text-gray-400">& Infrastructure</span>
            </motion.h1>
            ...
            >
              Scalable, secure, and high-performance cloud solutions on AWS, Azure, 
              and Google Cloud. From migration to management, we help UAE enterprises 
